...
<div style="margin: 25px 0; display: flex; gap: 16px; flex-wrap: wrap; justify-content: center;">
  <img src="/assets/projects/NASA/nasa_team1.jpeg" alt="Team selfie at NASA Johnson Space Center" style="width: 48%; border-radius: 12px; box-shadow: 0 2px 8px rgba(0,0,0,0.08);">
  <img src="/assets/projects/NASA/nasa_2.jpeg" alt="Anekha in spacecraft cockpit at NASA" style="width: 48%; border-radius: 12px; box-shadow: 0 2px 8px rgba(0,0,0,0.08);">
</div>

<div style="margin-top: 16px; text-align: center;">
  <img src="/assets/projects/NASA/nasa_team3.jpeg" alt="Team group photo at NASA" style="max-width: 45%; border-radius: 12px; box-shadow: 0 2px 8px rgba(0,0,0,0.08);">
</div>
