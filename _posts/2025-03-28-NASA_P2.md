...
<div style="margin: 25px 0; display: flex; gap: 16px; flex-wrap: wrap; justify-content: center; align-items: center;">
  <img src="/assets/projects/NASA/nasa_team1.jpeg" alt="Team at NASA Johnson Space Center" style="width: 48%; height: auto; border-radius: 12px; box-shadow: 0 2px 8px rgba(0,0,0,0.08);">
  <img src="/assets/projects/NASA/nasa_team3.jpeg" alt="Team group photo at NASA" style="width: 35%; height: auto; border-radius: 12px; box-shadow: 0 2px 8px rgba(0,0,0,0.08);">
</div>
